...
import { formatCurrency, formatUnixDateTime, renderValue, toErrorMessage } from '@/lib/utils';
...
export default function AdminEnterpriseDetailPage() {
  ...
  const backButton = (
    <Button
      ...
      variant="outline"
      size="sm"
      onClick={() => navigate('/dashboard/enterprises')}
    ...
    return (
      <div className={`${CARD} space-y-4`}>
        <div className="flex items-center justify-between">
          <h1 className="text-dash-fg text-xl font-bold">Wirausaha Tidak Ditemukan</h1>
          {backButton}
        </div>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div className={`${CARD} space-y-5`}>
          <h2 className="text-dash-fg border-dash-border border-b pb-3 text-base font-bold">
            Informasi Usaha
          </h2>
        ...
        <div className={`${CARD} space-y-5`}>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className={VALUE_CLASS}>
                {enterprise.capital_access ? GENERAL_STATUS_LABELS[enterprise.capital_access] : '—'}
              </p>
            </div>
            <div>
