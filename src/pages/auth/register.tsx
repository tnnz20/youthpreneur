  ...
  return (
    <Card className="border-brand-dark shadow-solid-lg w-full gap-0 rounded-3xl border-2 bg-white p-6 py-6 ring-0 sm:p-10">
      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        ...
        <div>
          <label htmlFor="register-email" className="text-brand-dark mb-1 block text-xs font-bold">
            Email
          </label>
          <Input
            id="register-email"
        ...
        <div>
          <label htmlFor="register-phone" className="text-brand-dark mb-1 block text-xs font-bold">
            Nomor WhatsApp
          </label>
          <Input
            id="register-phone"
